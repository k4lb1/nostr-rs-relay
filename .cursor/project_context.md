...
- **Teil 4:** LMDB abgeschlossen: LmdbRepo implementiert; write_event + query_subscription (ids, authors, kinds, since, until, limit); Pay-to-Relay/NIP-05 → Err; build_repo panic wenn pay_to_relay.enabled
