...
/// Admin error reporting (Kind 1984). Relay signs, admin receives via #p.
/// Optional: also send encrypted DM (Kind 4) to admin.
#[derive(Debug, Clone, Serialize, Deserialize)]
#[allow(unused)]
...
impl Default for Settings {
    fn default() -> Self {
        Settings {
            admin_error: AdminError::default(),
            info: Info {
                relay_url: None,
