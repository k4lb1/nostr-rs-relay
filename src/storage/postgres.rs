...
/// Postgres-backed storage. Wraps PostgresRepo and implements the slim Storage trait.
pub struct PostgresStorage {
    repo: std::sync::Arc<crate::repo::postgres::PostgresRepo>,
}

impl PostgresStorage {
    /// Create from existing PostgresRepo.
    #[must_use]
    pub fn new(repo: std::sync::Arc<crate::repo::postgres::PostgresRepo>) -> Self {
        Self { repo }
    }
}
